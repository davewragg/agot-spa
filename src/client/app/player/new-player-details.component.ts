...
@Component({
  moduleId: module.id,
  selector: 'agot-new-player-details',
  templateUrl: 'new-player-details.component.html',
})
export class NewPlayerDetailsComponent implements OnInit {
  player: Player;
    ...
    this._route.params
      ...
      .switchMap((criteria: FilterCriteria) =>
        Observable.combineLatest(
          ...
          this._statsService.getPlayerStatsNew(this.playerIdParam, criteria)
        )).subscribe(
